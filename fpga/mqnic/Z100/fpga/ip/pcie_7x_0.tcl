...
# <./Z100_pcie_test/Z100_pcie_test.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
  create_project Z100_pcie_test Z100_pcie_test -part xc7z035ffg900-2
